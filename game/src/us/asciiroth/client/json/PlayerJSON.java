...
public class PlayerJSON extends JavaScriptObject {
    
    public static final native PlayerJSON parseJSON(String json) /*-{
        return eval('('+json+')');
    }-*/;
    ...
    public final native JsArray<BagEntryJSON> bag() /*-{
        return this.bag;
    }-*/;
}